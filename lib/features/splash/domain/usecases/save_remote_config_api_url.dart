...
@injectable
class SaveRemoteConfigApiUrl extends UseCase<Unit, RemoteConfigParams> {
  const SaveRemoteConfigApiUrl(this._repository);
  final RemoteConfigRepository _repository;
  @override
  Future<Either<Failure, Unit>> call(RemoteConfigParams params) async {
    return _repository.saveApiUrl(params.remoteConfig);
  }
}
