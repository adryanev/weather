...
import 'core/di/firebase_module.dart' as _i16;
import 'core/presentation/blocs/flash/flash_cubit.dart' as _i4;
import 'features/splash/data/datasources/local_config_data_source.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i8.LocalConfigDataSource>(
      () => _i8.LocalConfigDataSourceImpl(get<_i6.LocalStorage>()));
  gh.lazySingleton<_i9.RemoteConfigRepository>(() =>
      _i10.RemoteConfigRepositoryImpl(
          get<_i7.RemoteConfigDataSource>(), get<_i8.LocalConfigDataSource>()));
  gh.factory<_i11.SaveRemoteConfigApiKey>(
      () => _i11.SaveRemoteConfigApiKey(get<_i9.RemoteConfigRepository>()));
  gh.factory<_i12.SaveRemoteConfigApiUrl>(
      () => _i12.SaveRemoteConfigApiUrl(get<_i9.RemoteConfigRepository>()));
  gh.factory<_i13.FetchRemoteConfigApiKeyUseCase>(() =>
      _i13.FetchRemoteConfigApiKeyUseCase(get<_i9.RemoteConfigRepository>()));
  gh.factory<_i14.FetchRemoteConfigApiUrlUseCase>(() =>
      _i14.FetchRemoteConfigApiUrlUseCase(get<_i9.RemoteConfigRepository>()));
  gh.factory<_i15.SplashCubit>(() => _i15.SplashCubit(
      get<_i13.FetchRemoteConfigApiKeyUseCase>(),
      get<_i14.FetchRemoteConfigApiUrlUseCase>(),
      get<_i11.SaveRemoteConfigApiKey>(),
      get<_i12.SaveRemoteConfigApiUrl>()));
  return get;
}
